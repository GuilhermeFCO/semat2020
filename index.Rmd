...
.center[
```{r cnpq, echo=FALSE, out.width='75%'}
...
.center[
``` {r Site1, echo=FALSE, out.width='75%'}
...
knitr::include_graphics('img/SiteTCC2.png')
```
]
  ]
  .panel[.panel-name[PDF]
...
.center[
<a href="https://www.linkedin.com/in/guilherme-fernandes-castro-de-oliveira-6787751aa"><i class="fab fa-linkedin" style="font-size:40px;"></i></a>
<a href="https://github.com/GuilhermeFCO"><i class="fab fa-github" style="font-size:40px;"></i></a>
<a href="https://www.facebook.com/profile.php?id=100008082376367"><i class="fab fa-facebook" style="font-size:40px;"></i></a>
