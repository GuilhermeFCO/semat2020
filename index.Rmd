...
.center[
```{r fernando, echo=FALSE, out.width='22%'}
knitr::include_graphics('img/fernando.jpg')
```
]
.center[
<a href="https://www.linkedin.com/in/fsbmat/"><i class="fab fa-linkedin" style="font-size:28px;"></i></a>
<a href="https://github.com/fsbmat-ufv"><i class="fab fa-github" style="font-size:28px;"></i></a>
<a href="https://fsbmat-ufv.github.io/"><i class="fas fa-globe" style="font-size:28px;"></i></a>
]

### Apoio

.center[
```{r cnpq, echo=FALSE, out.width='40%'}
...
- .justify[
Devido ao modo de transmissão vários lugares do mundo decretaram isolamento social já que até o momento não há medicamento para o combate e enfrentamento da doença.
]
